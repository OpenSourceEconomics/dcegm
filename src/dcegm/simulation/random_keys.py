...
def draw_random_keys_for_seed(n_agents, n_periods, taste_shock_scale_is_scalar, seed):
    ...
    idx_2 = n_exog_processes_transition_keys
    ...
    if taste_shock_scale_is_scalar:
        ...
        idx_3 = n_exog_processes_transition_keys + 1
    else:
        n_keys_taste_shock_per_period = n_agents
        idx_3 = jnp.arange(
            start=n_exog_processes_transition_keys + 1,
            stop=n_exog_processes_transition_keys + n_keys_taste_shock_per_period + 1,
        )
