...
def test_fast_upper_envelope_against_fedor_credit_constrained():
    policy_egm = np.genfromtxt(TEST_RESOURCES_DIR / "pol18.csv", delimiter=",")
    policy_fedor = np.genfromtxt(TEST_RESOURCES_DIR / "expec_pol18.csv", delimiter=",")

    value_egm = np.genfromtxt(TEST_RESOURCES_DIR / "val18.csv", delimiter=",")
    value_fedor = np.genfromtxt(TEST_RESOURCES_DIR / "expec_val18.csv", delimiter=",")
    ...
    ax.set_xlabel("$m_t$")
    ax.set_ylabel("$c_t$")
    fig.savefig("fedor_val18.png", dpi=300)
    ...
    ax.set_xlabel("$m_t$")
    ax.set_ylabel("$c_t$")
    fig.savefig("fues_val18.png", dpi=300)
    ...
    ax.set_xlabel("$m_t$")
    ax.set_ylabel("$c_t$")
    fig.savefig("fedor_pol18.png", dpi=300)
    ...
    ax.set_xlabel("$m_t$")
    ax.set_ylabel("$c_t$")
    fig.savefig("fues_pol18.png", dpi=300)
