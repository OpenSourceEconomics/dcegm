...
# correct outputs
current_policy_output = pkl.load(
    open(TEST_RESOURCES_DIR / "current_policy_output.pkl", "rb")
)
current_value_output = pkl.load(
    open(TEST_RESOURCES_DIR / "current_value_output.pkl", "rb")
)
